...
// add section to manage breadcrumb settings
	...
	$wp_customize->add_control('spice_software_breadcrumb_type_breadcrumb_type', array(
		...
		'description' => esc_html__( 'If you use other than "default" one you will need to install and activate respective plugins Breadcrumb NavXT, Yoast SEO and Rank Math SEO', 'spice-software' ),
        'section' => 'breadcrumb_setting_section',
		'setting' => 'spice_software_breadcrumb_type_breadcrumb_type',
		'type'    =>  'select',
		'choices' =>  array(
			'default' => __( 'Default(Blank)', 'spice-software' ),
            'yoast'  => __( 'Yoast SEO', 'spice-software' ),
            'rankmath'  => __( 'Rank Math', 'spice-software' ),
			'navxt'  => __( 'NavXT', 'spice-software' ),
			)
	));
